...
### PT Mode — ONDW
- ⬜ **[NEW Jul 29] Dark-mode contrast audit — Zara implementing all 12 real code fixes now** (background agent, exact spec matching the confirmed Figma mockups). Push-notification permission popup (`public/customJS/push-notifications.js:82-106`) checked separately — already has proper dark: classes throughout, no fix needed there. Not committed yet — Yappy reviewing diff first.
